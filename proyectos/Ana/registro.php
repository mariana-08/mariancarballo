...
// Valores enviados desde el formulario
  if ( !isset($_POST["nombre1"]) || !isset($_POST["email1"])) {
...
$mail->From = $email1; // Email desde donde envío el correo.
$mail->AddAddress($emailDestino); // Esta es la dirección a donde enviamos los datos del formulario
$mail->Subject = "Suscripción al Newsletter - Ana Giorgi"; // Este es el titulo del email.
$mensajeHtml = nl2br($nombre1);
...
<p style='color:#333333!important; font-family:Poppins-Bold !important; text-decoration:none;font-size:26px; line-height:10px;float:right;'>Registro para el New </p></td></tr><tr><td style='font-size:15px;color:#333333'><strong><p style='font-size:20px;'>Se registraron para recibir el News:</strong> <hr><br><br>
De: $nombre1<br>  
Email: $email1 <br><br><hr>
